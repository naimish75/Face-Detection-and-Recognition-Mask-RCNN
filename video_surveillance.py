...
db = mysql.connector.connect(host="localhost",user="root",passwd="toor",database="maskRcnn")
mycur = db.cursor()
...
def login():
    ...
    Label(root2, text="").pack()
    Button(root2, text="Log-In", bg="red",command=login_verify).pack()
    Label(root2, text="")
